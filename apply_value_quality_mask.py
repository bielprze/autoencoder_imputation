...
# Główna reguła jakości.
# Jeśli wartości oznaczają liczbę pojazdów w 10-minutowym przedziale,
# to wartości powyżej tego progu traktujemy jako fizycznie niewiarygodne.
MAX_REASONABLE_VALUE = 1500

# Opcjonalnie: wartości ujemne też są niewiarygodne.
MIN_REASONABLE_VALUE = 0

# Czy zamieniać outliery na NaN w plikach *_qc.csv.
REPLACE_INVALID_WITH_NAN = True

# Czy zapisać maski valid/invalid.
SAVE_VALID_MASKS = True

# Czy zapisać osobny plik z listą wszystkich invalid punktów.
SAVE_INVALID_POINTS = True

# Progi diagnostyczne, tylko do raportu.
